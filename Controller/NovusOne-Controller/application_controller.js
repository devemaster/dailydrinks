                  ...
                  client.query(del, (delerr, delress) => {
                    if (delerr) {
                      ...
                      const applicationName =
                        searchress.rows[0].application_name;
                      redisClient.hdel(
                        "application",
                        applicationName,
                        function (err, redisdata) {
                            ...
                            if (err) {
                              ...
                              if (data == "OK") {
                                ...
                                for (let appData of app_user) {
                                  const sqlApp = `insert into app_user(application_id,user_name,user_id,status,role_id,country) values('${
                                    appData.application_id
                                  }','${
                                    appData.user_name
                                  }','${userId}','${1}','${rollid}','${country}')RETURNING app_id`;
